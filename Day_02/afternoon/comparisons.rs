...
PartialOrd and Ord
PartialOrd defines a partial ordering, with a partial_cmp methods. It is used
...
/*
Ord is a total ordering, with cmp returing Ordering.

PartialEq can be implemented between different types, but Eq cannot, it is
reflexive:
